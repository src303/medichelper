...
ffunction update()
    ...
    downloadUrlToFile("https://raw.githubusercontent.com/src303/medichelper/main/Update.json", updatePath, function(id, status, p1, p2)
            ...
            if file and doesFileExist(updatePath) then
                ...
                if info.version ~= thisScript().version then
                    lua_thread.create(function()
                        ...
                        downloadUrlToFile("https://raw.githubusercontent.com/src303/medichelper/main/Medick_Helper.lua", thisScript().path, function(id, status, p1, p2)
                            if status == dlstatus.STATUS_ENDDOWNLOADDATA then
